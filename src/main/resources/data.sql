...
-- REVIEW
INSERT INTO REVIEW (
    REPORT_COUNT, CAFE_ID, CREATED_AT, USER_USER_ID,  R_CONTENT
)
VALUES
    -- CAFE_ID 1에 대한 리뷰 엔트리
    (1, 100, '2024-11-01', 100, '츄러스가 바삭하고 맛있었지만 음료가 다소 평범했어요.'),
    (2, 100, '2024-11-03', 101, '카페 분위기가 좋아서 친구들과 재밌게 시간을 보냈습니다.'),
    (1, 100, '2024-11-05', 100, '주차 공간이 협소해 불편함이 있었어요.'),

    -- CAFE_ID 2에 대한 리뷰 엔트리
    (3, 101, '2024-10-15', 100, '국밥이 뜨겁고 깊은 맛이 나서 좋았습니다.'),
    (1, 101, '2024-10-20', 101, '식당이 너무 붐벼서 조용히 식사하기 어려웠습니다.'),
    (2, 101, '2024-11-01', 101, '친절한 서비스 덕분에 기분 좋은 식사를 할 수 있었습니다.');
